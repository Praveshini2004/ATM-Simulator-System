...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne(){
        ...
        ImageIcon i1 = new ImageIcon("src/icons/atmlogo.jpg");
	...
	dateChooser.setForeground(new Color(105, 105, 105));
	 dateChooser.setBounds(137, 337, 200, 29);
        ...
        l12.setBounds(100, 570, 200, 30);
        add(l12);
        
        t7.setBounds(300, 570, 400, 30);
        add(t7);
        
        b.setBounds(570,610,100,25);
        add(b);
