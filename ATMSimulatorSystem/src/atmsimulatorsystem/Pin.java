...
public class Pin extends JFrame implements ActionListener {
    ...
    Pin(String pin) {
        ...
        l2.setBounds(centerX - 200, y, 200, 35);
        l4.add(l2);
        t1.setBounds(centerX, y, 180, 25);
        l4.add(t1);
        y += 50;

        l3.setBounds(centerX - 200, y, 200, 35);
        l4.add(l3);
        t2.setBounds(centerX, y, 180, 25);
        l4.add(t2);
        y += 70;
        ...
        b2.setBounds(centerX - 75, y, 150, 35);
        l4.add(b2);
